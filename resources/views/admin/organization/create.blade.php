                                ...
                                <div class="block-card mb-4">
                                    ...
                                    <div class="block-card-body">
                                        <form method="post" class="form-box row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-box">
                                                    <label class="label-text d-flex align-items-center ">Menu Web
                                                        Address</label>
                                ...
                                <div class="block-card mb-4">
                                    ...
                                    <div class="block-card-body">
                                        <form method="post" class="form-box row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-box">
                                                    <label class="label-text">For precise location, drag the red marker
                                                        on the map.</label>
                                                ...
                                                <tr class="business-opening-wrap">
                                                    ...
                                                    <td class="user-chosen-select-container">
                                                        <select class="user-chosen-select">
                                                            ...
                                                            <option value="09:00 am" selected="selected">09:00 am
                                                            </option>
                                                    ...
                                                    <td class="user-chosen-select-container">
                                                        <select class="user-chosen-select">
                                                            ...
                                                            <option value="08:30 pm">08:30 pm</option>
                                                            <option value="08:45 pm">08:45 pm</option>
                                                            <option value="09:00 pm" selected="selected">09:00 pm
                                                            </option>
                                                            <option value="09:15 pm">09:15 pm</option>
                                                            <option value="09:30 pm">09:30 pm</option>
                                                            <option value="09:45 pm">09:45 pm</option>
