    ...
    <div class="container-fluid dashboard-inner-body-container">
        <div class="breadcrumb-content d-sm-flex align-items-center justify-content-between mb-4">
            <div class="section-heading">
                <h2 class="sec__title font-size-24 mb-0">Howdy, Kamran!</h2>
            </div>
                        ...
                        <div class="my-table table-responsive">
                            <table class="table align-items-center table-flush mb-0">
                                ...
                                <tr>
                                    ...
                                    <td><a href="invoice.html" class="btn btn-sm theme-btn-primary">Invoice</a>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="block-card-body pt-0">
                        <div class="generic-list msg-from-customer">
                            ...
                            <a class="dropdown-item text-center small text-gray font-weight-medium py-2"
                               href="dashboard-messages.html">View More <i
