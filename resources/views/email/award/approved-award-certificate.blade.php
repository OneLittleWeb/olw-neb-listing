                ...
                <tr>
                    <td align="center" bgcolor="#ffffff"
                        ...
                        <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">
                            Congratulations!<br>
                            We have updated you business details.
                        </h1>
                    </td>
                </tr>
            </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0;">Thanks for contacting us for the {{ env('APP_NAME') }} Award Certificate.
                            Here is your certificate code. You can place this code anywhere on your website.
                            <br> <br>
