            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0;">Thank you for reaching out regarding the Nebraskalisting Award Certificate
                            for your business, <a
                                ...
                                target="_blank">{{ $award_certificate->organization->organization_name }}</a>.</p>

                        <p>Unfortunately, we are unable to provide the {{ env('APP_NAME') }} award certificate due to
                            certain reasons. You can <a href="{{ route('page.contact') }}">Contact US</a> or send mail
                            at <a href="mailto: {{ env('SUPPORT_MAIL_ADDRESS') }}">{{ env('SUPPORT_MAIL_ADDRESS') }}</a>.
                        </p>
                        <p>If you didn't expect an email from <a href="{{ env('APP_URL') }}">{{ env('APP_URL') }}</a>, you
