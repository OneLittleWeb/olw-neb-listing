                ...
                <div class="col-lg-6">
                    <div class="hero-heading">
                        <div class="section-heading">
                            <h2 class="sec__title mb-3 line-height-60">Listhub helps you find out whats happening in
                                your
    ...
    <section class="category-area bg-gray arrow-down-shape position-relative section-padding">
        <div class="container">
            ...
            <div class="more-btn-box pt-3 text-center">
                <a href="{{ route('counties.index') }}" class="btn-gray hover-scale-2">Browse All County <i
                        class="la la-arrow-right ml-2"></i></a>
            </div>
        </div><!-- end container -->
                ...
                <div class="col-lg-5">
                    <div class="card-heading-content mt-0">
                        <div class="section-heading">
                            ...
                            <h2 class="sec__title">Check out Our Trending <span
                                    class="text-color-16">Destinations.</span>
                            </h2>
                            <p class="sec__desc">
