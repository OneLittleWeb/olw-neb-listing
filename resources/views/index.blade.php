...
@section('content')
<section class="hero-wrapper hero-bg-4 pb-0">
    <div class="overlay opacity-9"></div><!-- end overlay -->
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="hero-heading">
                    <div class="section-heading">
                        <h2 class="sec__title mb-3 line-height-60">Listhub helps you find out whats happening in your
                            city, Let's explore.</h2>
                        <p class="sec__desc line-height-35">
                            Simple, Yet powerful local business directory where buyers and sellers engage
                            each others with trust.
                        </p>
                    </div>
                    <div class="btn-box padding-top-35px">
                        <a href="about.html" class="theme-btn gradient-btn shadow-none">Know More<i
    ...
    <div class="highlighted-categories bg-dark-opacity margin-top-130px">
        <div class="highlight-lists d-flex justify-content-center align-items-center">
            <h5 class="highlighted__title pr-5">Browse by Category <i class="la la-arrow-right ml-2"></i></h5>
            <div class="hero-category-item rounded-0">
                <a href="#" class="d-block hero-cat-link rounded-0">
...
<section class="card-area section-padding">
    <div class="container-fluid padding-right-50px padding-left-50px">
            ...
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    <div class="section-badge pb-3">
                        <span class="ribbon ribbon-lg">Popular Listing</span>
                    </div>
                    <h2 class="sec__title">Most Popular <span class="text-color-16">Listings.</span></h2>
                    <p class="sec__desc">
        ...
        <div class="row padding-top-60px">
            <div class="col-lg-12">
                <div class="card-carousel-2 owl-trigger-action">
                    <div class="card-item border border-color">
                        <div class="card-image">
                            <a href="listing-details.html" class="d-block">
                                <img src="{{asset('/images/img4.jpg')}}" class="card__img" alt="">
                        ...
                        <div class="card-content">
                            <a href="#" class="user-thumb d-inline-block" data-toggle="tooltip" data-placement="top"
                               title="TechyDevs">
                                <img src="{{asset('/images/listing-logo.jpg')}}" alt="author-img">
                            </a>
            ...
            <div class="col-lg-5">
                <div class="card-heading-content mt-0">
                    <div class="section-heading">
                        ...
                        <h2 class="sec__title">Check out Our Trending <span class="text-color-16">Destinations.</span>
                        </h2>
                        <p class="sec__desc">
                ...
                <div class="row">
                    <div class="col-lg-6 responsive-column">
                        <div class="category-item category-item-layout-2 category-item-layout--2 js-tilt-2 ">
                            <img src="{{asset('/images/img4.jpg')}}" data-src="{{asset('/images/img4.jpg')}}" alt="category-image"
                                 class="cat-img lazy">
                            <div class="category-content">
                                <a href="#" class="category-link d-flex align-items-end w-100 h-100 text-left">
                                    <div
                                        class="category-content-inner d-flex align-items-center justify-content-between">
                                        <div>
                                            <h4 class="cat__title mb-1">Canada</h4>
                                            <span class="font-weight-medium font-size-15">72 Listings</span>
                                        </div>
                        ...
                        <div class="category-item category-item-layout-2 category-item-layout--2 js-tilt-2 ">
                            <img src="{{asset('/images/img4.jpg')}}" data-src="{{asset('/images/img4.jpg')}}" alt="category-image"
                                 class="cat-img lazy cat-img-height">
                            <div class="category-content">
                                <a href="#" class="category-link d-flex align-items-end w-100 h-100 text-left">
                                    <div
                                        class="category-content-inner d-flex align-items-center justify-content-between">
                                        <div>
                                            <h4 class="cat__title mb-1">New York</h4>
                                            <span class="font-weight-medium font-size-15">44 Listings</span>
                                        </div>
                                        <i class="la la-arrow-right"></i>
                                    </div>
                                </a>
                            ...
                            <div class="category-content">
                                <a href="#" class="category-link d-flex align-items-end w-100 h-100 text-left">
                                    <div
                                        class="category-content-inner d-flex align-items-center justify-content-between">
                                        <div>
                                            <h4 class="cat__title mb-1">United Kingdom</h4>
                                            <span class="font-weight-medium font-size-15">22 Listings</span>
                                        </div>
                                        <i class="la la-arrow-right"></i>
                                    </div>
                                </a>
                            ...
                            <div class="category-content">
                                <a href="#" class="category-link d-flex align-items-end w-100 h-100 text-left">
                                    <div
                                        class="category-content-inner d-flex align-items-center justify-content-between">
                                        <div>
                                            <h4 class="cat__title mb-1">Italy</h4>
                                            <span class="font-weight-medium font-size-15">55 Listings</span>
                                        </div>
                                        <i class="la la-arrow-right"></i>
                                    </div>
                                </a>
    ...
    <div class="container">
        ...
        <div class="row hiw-info-box-wrap">
            ...
            <div class="col-lg-3 responsive-column">
                <div class="info-box info--box">
                    <div class="info-icon gradient-icon">
                        <svg width="40" version="1.1" id="Capa_221" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            ...
            <div class="col-lg-3 responsive-column">
                <div class="info-box info--box">
                    <div class="info-icon gradient-icon">
                        <svg width="40" version="1.1" id="Capa_1211" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                             viewBox="0 0 512 512" xml:space="preserve">
                               <defs>
...
<section class="blog-area section-padding">
    <div class="container">
        ...
        <div class="row padding-top-60px">
            <div class="col-lg-8">
                <div class="card-item card-item-layout-5 js-tilt">
                    <div class="card-image">
                        <img src="{{asset('/images/img4.jpg')}}" data-src="{{asset('/images/img4.jpg')}}" class="card__img lazy"
                             alt="blog image">
                    ...
                    <div class="card-content">
                        ...
                        <div class="avatar-photos pt-4">
                            ...
                            <a href="#" class="user-thumb" data-toggle="tooltip" data-placement="top" title="John Doe">
                                <img src="{{asset('/images/img4.jpg')}}" alt="Avatar image">
                            </a>
                            <a href="#" class="user-thumb" data-toggle="tooltip" data-placement="top"
                               title="Aron Finch">
                ...
                <div class="card-item card-item-layout-5 js-tilt">
                    ...
                    <div class="card-content">
                        ...
                        <div class="avatar-photos pt-4">
                            ...
                            <a href="#" class="user-thumb" data-toggle="tooltip" data-placement="top" title="Wes Boss">
                                <img src="{{asset('/images/img4.jpg')}}" alt="Avatar image">
                            </a>
                        </div>
                    </div><!-- end card-content -->
        ...
        <div class="more-btn-box d-flex flex-wrap align-items-center justify-content-between pt-4">
            ...
            <a href="blog-grid.html" class="theme-btn gradient-btn">Read More Post<i class="la la-arrow-right ml-2"></i></a>
        </div>
    </div><!-- end container -->
                ...
                <div class="cta-content p-0">
                    <div class="section-heading">
                        ...
                        <p class="sec__desc text-white line-height-35 mb-3">
                            Your business deserves efficiently unleash cross-media information without cross-media value
                            <br>
            ...
            <div class="modal-body">
                <form method="post" class="form-box">
                    ...
                    <div class="input-box">
                        ...
                        <p class="font-size-14 mt-n2">Your password must be at least 6 characters long and must contain
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="font-size-15 font-weight-medium pb-3">
                    ...
                    You will receive an email with instructions on how to reset your password. If you are experiencing
                    problems
                    resetting your password <a href="contact.html" class="text-color-2">contact us</a> or <a href="#"
