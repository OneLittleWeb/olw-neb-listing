...
@section('content')
    <section>
        <div class="container" style="margin-top: 140px; margin-bottom: 70px">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to Speedy Calculator.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Speedy Calculator, accessible from <a
                            href="nebraskalisting.com" rel="external nofollow noopener" target="_blank">nebraskalisting.com</a>
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: support@nebraskalisting.com</li>
            </ul>
        </div>
    </section>
@endsection
