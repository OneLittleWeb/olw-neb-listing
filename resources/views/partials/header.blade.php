            ...
            <div class="row">
                <div class="col-lg-6 d-flex align-items-center header-top-info font-size-14">
                    <p class="mr-3 pr-3 border-right border-right-color">
                        <span class="mr-1 text-white font-weight-semi-bold">Email:</span>
                        <a href="#" class="font-weight-medium">olw@gmail.com</a>
                    </p>
                    <p>
                        <span class="mr-1 text-white font-weight-semi-bold">Phone:</span>
                        <a href="#" class="font-weight-medium">+98 76543210</a>
                    </p>
                </div><!-- end col-lg-6 -->
